...
app = Flask(__name__, template_folder='/home/project/predict_parser') #r'C:\Users\vitalii\IdeaProjects\settings\parser\test\\'
...
def index():
    ...
    if request.method == 'POST':
        ...
        with open(r'/home/project/gpt_rewrite_prompt.txt', 'r', encoding="utf-8") as file:
